...
public class Realm2_1 implements CurrentLevel
{
	public int x;
	public int y;
	private int t, count;
	...
	File cFile = new File("res/realm2_1Coord.txt");
	...
	//bounds for floor
		...
		public Realm2_1(int x, int y, ImageManager im, SpriteSheet ss, Player plyr)
		{
			this.im = im;
			this.ss = ss;
			player = plyr;
